...
<div class="card">
  <img src="mensfashion/shoes/sandle 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">white sandle</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/shoes/sandle 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">black sandle</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/shoes/shoes 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/shoes/joggers.jpg" class="card-img-top" alt="...">
  <div class="card-body">
