...
<div class="card">
  <img src="groceries/frozen food/croquettes.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">croquettes</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/frozen food/nuggets.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">nuggets</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/frozen food/samosa.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">samosa</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/frozen food/spring roll.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">spring roll</h1>
    <ul class="pagination">
        <li class="page-item">
