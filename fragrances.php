...
<div class="card">
  <img src="healthandbeauty/fragnances/Chanel perfume for women.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Chanel perfume women</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/fragnances/Bvlgari Men Perfume.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Bvlgari Men Perfume</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/fragnances/oribe perfume women.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">oribe perfume women</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/fragnances/eternity for men.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">eternity for men</h1>
    <ul class="pagination">
        <li class="page-item">
