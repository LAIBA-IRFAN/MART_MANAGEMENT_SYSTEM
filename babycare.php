...
<div class="card">
  <img src="kidsandbabies/baby care/baby brush.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">baby brush</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby care/baby lotion.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">baby lotion</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby care/baby cream.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">baby cream</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby care/baby oil.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">baby oil</h1>
    <ul class="pagination">
        <li class="page-item">
