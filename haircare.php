...
<div class="card">
  <img src="healthandbeauty/hair care/keratine mask.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">keratine mask</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/hair care/pantene conditionar.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">pantene conditioner</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/hair care/sunsilk shampoo.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">sunsilk shampoo</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/hair care/tresemme conditionar.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">tresemme conditioner</h1>
    <ul class="pagination">
        <li class="page-item">
