...
<div class="card">
  <img src="groceries/baking and cooking/baking powder.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">baking powder</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/baking and cooking/cooking oil.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">cooking oil</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/baking and cooking/yeast.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">yeast</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/baking and cooking/coco powder.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">coco powder</h1>
    <ul class="pagination">
        <li class="page-item">
