...
<div class="card">
  <img src="healthandbeauty/bathing and body/nivia soap.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">nivea soap</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/bathing and body/hand wash.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">hand wash</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/bathing and body/body soap.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">olay soap</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/bathing and body/body wash.Jpeg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Pears body wash</h1>
    <ul class="pagination">
        <li class="page-item">
...
<script type="text/javascript">
    ...
    itemprice.innerHTML  = parseInt(itemprice.innerHTML) - 60;
    product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 60;
