...
<div class="card">
  <img src="kidsandbabies/baby food/cerelac.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">cerelac red fruits</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby food/baby milk powder.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">meiji milk powder</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby food/baby milk powder 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">nestle milk powder</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby food/cerelac 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">nestle cerelac banana</h1>
    <ul class="pagination">
        <li class="page-item">
