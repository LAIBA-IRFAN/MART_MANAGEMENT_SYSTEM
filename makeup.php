...
<div class="card">
  <img src="healthandbeauty/makeup/foundation.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">foundation</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/makeup/eye liner.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">eye liner</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/makeup/highligthers.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">highlighters</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/makeup/lipstick.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">lipstick</h1>
    <ul class="pagination">
        <li class="page-item">
