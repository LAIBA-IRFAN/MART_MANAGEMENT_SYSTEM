...
<div class="card">
  <img src="kidsandbabies/baby watches/baby watches.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Pink watch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby watches/baby watches 7.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">black watch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby watches/baby watches 5.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">red watch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby watches/baby watches 3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">blue watch</h1>
    <ul class="pagination">
        <li class="page-item">
