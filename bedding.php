...
<div class="card">
  <img src="homeandlifestyle/beding/Embroidered-Bedsheets-.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Embroidered Bedsheets</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/beding/pillow.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">pillow</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/beding/blanket 3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">blanket</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/beding/bed sheets 1.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">printed bedsheet</h1>
    <ul class="pagination">
        <li class="page-item">
