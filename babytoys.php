...
<div class="card">
  <img src="kidsandbabies/baby  toys/baby 5.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">red car for babies</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby  toys/toy 6.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">pink teddy bear</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby  toys/toy 7.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">blue teddy bear</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/baby  toys/toy.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">keys</h1>
    <ul class="pagination">
        <li class="page-item">
