...
<div class="card">
  <img src="groceries/vegetables/capsicum.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">capsicum</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/vegetables/carrot.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">carrot</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/vegetables/potato.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/vegetables/tomato.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<script type="text/javascript">
    ...
    itemprice.innerHTML  = parseInt(itemprice.innerHTML) - 90;
    product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 90;
