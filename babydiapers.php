...
<div class="card">
  <img src="kidsandbabies/diapers/diaper 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Tifal diaper</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/diapers/diaper 3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Pampers diaper</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/diapers/diaper 5.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">bumble diaper</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="kidsandbabies/diapers/babr wipes.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">baby wipes</h1>
    <ul class="pagination">
        <li class="page-item">
