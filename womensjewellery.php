...
<div class="card">
  <img src="womensfashion/women jewellary/bracelet 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">bracelet</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women jewellary/earing 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">earings</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women jewellary/necklace.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">necklace</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women jewellary/ring 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">ring</h1>
    <ul class="pagination">
        <li class="page-item">
...
<script type="text/javascript">
    ...
    product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 1500;
