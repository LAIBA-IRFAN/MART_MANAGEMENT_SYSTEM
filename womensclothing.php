...
<div class="card">
  <img src="womensfashion/women clothing/unstiched suit.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">unstiched suit</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women clothing/khaddi lawn suit.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">khaadi lawn suit</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women clothing/chiffon dress 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">chiffon dress</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women clothing/multi lawn suit.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">multi lawn suit</h1>
    <ul class="pagination">
        <li class="page-item">
...
<script type="text/javascript">
    ...
    itemprice.innerHTML  = parseInt(itemprice.innerHTML) - 2000;
    product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 2000;
