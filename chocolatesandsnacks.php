...
<div class="card">
  <img src="groceries/chocolate and snacks/dairy mik.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">cadbury dairymilk</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/chocolate and snacks/kitkat.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/chocolate and snacks/bounty.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">bounty</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/chocolate and snacks/snickers.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">snickers</h1>
    <ul class="pagination">
        <li class="page-item">
...
<script type="text/javascript">
    ...
    itemprice.innerHTML  = parseInt(itemprice.innerHTML) - 210;
    product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 210;
