...
<div class="card">
  <img src="healthandbeauty/skin care/charcoal mask.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">charcoal mask</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/skin care/face moisturizer.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">face moisturizer</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/skin care/face wash.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">face wash</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="healthandbeauty/skin care/serum.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">serum</h1>
    <ul class="pagination">
        <li class="page-item">
