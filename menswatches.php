...
<div class="card">
  <img src="mensfashion/watches/smart watch 4.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">digital watch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/watches/smart watch 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/watches/watch 4.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">brown watch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/watches/watch  3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">silver watch</h1>
    <ul class="pagination">
        <li class="page-item">
