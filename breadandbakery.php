...
<div class="card">
  <img src="groceries/bakery items/brownies.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/bakery items/biscuits.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">biscuits</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/bakery items/pastries.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">pastries</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/bakery items/patties.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">patties</h1>
    <ul class="pagination">
        <li class="page-item">
