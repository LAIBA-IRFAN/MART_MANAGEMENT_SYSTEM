...
<div class="card">
  <img src="womensfashion/womwen shoes/joggers 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">joggers</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/womwen shoes/pumpy.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">pumpy</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/womwen shoes/sandle1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">sandle</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/womwen shoes/slipper.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">slipper</h1>
    <ul class="pagination">
        <li class="page-item">
