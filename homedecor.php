...
<div class="card">
  <img src="homeandlifestyle/home decor/carpet.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">carpet</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/home decor/curtain 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">curtain</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/home decor/mirror.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">mirror</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/home decor/wall clock.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">wall clock</h1>
    <ul class="pagination">
        <li class="page-item">
