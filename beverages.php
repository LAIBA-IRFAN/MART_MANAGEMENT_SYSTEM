...
<div class="card">
  <img src="groceries/beverages/slice juice.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">slice juice</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/beverages/fanta 1.5 liter.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">fanta 1.5 liter</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/beverages/coke 500 ml.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">coke 500 ml</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/beverages/pepsi 500 ml.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">pepsi 500 ml</h1>
    <ul class="pagination">
        <li class="page-item">
