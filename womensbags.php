...
<div class="card">
  <img src="womensfashion/women bags/bag 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">pink bag</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women bags/bag 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">mustard bag</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women bags/clutch.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">clutch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women bags/women wallet 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
