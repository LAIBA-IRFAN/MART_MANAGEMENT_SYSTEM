...
<div class="card">
  <img src="groceries/fruits/apple.png" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/fruits/orange.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Orange</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/fruits/grapes.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">Grapes</h1>
    <ul class="pagination">
        <li class="page-item">
