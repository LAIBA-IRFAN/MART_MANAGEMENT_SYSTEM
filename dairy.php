...
<div class="card">
  <img src="groceries/dairy/butter.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">butter</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/dairy/milk pac  cream.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">milkpak cream</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/dairy/cheddar cheese.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">cheddar cheese</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/dairy/mozzarela cheese.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">mozzarela cheese</h1>
    <ul class="pagination">
        <li class="page-item">
...
<script type="text/javascript">
    ...
    product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 600;
