...
<div class="card">
  <img src="homeandlifestyle/bath/bath room mat.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">bathroom mat</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/bath/bathroom  cabinet.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">bathroom cabinet</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/bath/towel  2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">towel</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="homeandlifestyle/bath/glass shelf for bathroom.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">glass shelf for bathroom</h1>
    <ul class="pagination">
        <li class="page-item">
