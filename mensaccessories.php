...
<div class="card">
  <img src="mensfashion/men accessories/tie 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">tie</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/men accessories/wallet.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/men accessories/men cufflinks.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">men cufflinks</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/men accessories/wallet 3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">leather wallet</h1>
    <ul class="pagination">
        <li class="page-item">
