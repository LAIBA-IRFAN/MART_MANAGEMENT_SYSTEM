...
<div class="card">
  <img src="womensfashion/women watches/smart watch 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">smart watch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women watches/watch.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women watches/watch 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">rosegold watch</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="womensfashion/women watches/smart watch 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">rosegold smart watch</h1>
    <ul class="pagination">
        <li class="page-item">
