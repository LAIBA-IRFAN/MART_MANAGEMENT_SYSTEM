...
<div class="card">
  <img src="mensfashion/clothing/jacket 1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/clothing/kurta pajama 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">kurta pajama</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/clothing/pant.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="mensfashion/clothing/shirt 2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
