...
<div class="card">
  <img src="groceries/seafood/lobster.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">lobster</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/seafood/crab.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">crab</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/seafood/prawns.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">prawns</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/seafood/red snapper.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">red snapper</h1>
    <ul class="pagination">
        <li class="page-item">
