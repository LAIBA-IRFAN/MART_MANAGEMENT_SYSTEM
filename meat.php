...
<div class="card">
  <img src="groceries/meat/beaf.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">beef</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/meat/chicken.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/meat/mutton.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
    <h1 class="card-title">mutton</h1>
    <ul class="pagination">
        <li class="page-item">
...
<div class="col-sm-12 col-md-6 col-lg-4">
<div class="card">
  <img src="groceries/fruits/banana.png" class="card-img-top" alt="...">
  <div class="card-body">
...
<script type="text/javascript">
    ...
    product_total_amt.innerHTML  = parseInt(product_total_amt.innerHTML) - 250;
